...
Vue.component('search',{
  ...
  template: `
  <div class="search">
    <goods-search  v-model="searchel"></goods-search>
    <search-button v-on:click.native="filterGoods(searchel)">Искать</search-button>
  </div>
`,

methods: {
  filterGoods: function (element) {
...
Vue.component('search-button', {
  template: `
    <button class="search-button cart-button" type="button">Искать</button>
  `
})
